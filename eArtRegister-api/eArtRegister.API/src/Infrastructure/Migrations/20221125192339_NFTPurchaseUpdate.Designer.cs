...
namespace eArtRegister.API.Infrastructure.Migrations
{
    ...
    [Migration("20221125192339_NFTPurchaseUpdate")]
    partial class NFTPurchaseUpdate
    {
            ...
            modelBuilder.Entity("eArtRegister.API.Domain.Entities.NFT", b =>
                {
                    ...
                    b.Property<string>("IPFSImageHash")
                        .HasColumnType("text")
                        .HasColumnName("ipfs_image_hash");

                    b.Property<string>("IPFSImageSize")
                        .HasColumnType("text")
                        .HasColumnName("ipfs_image_size");

                    b.Property<string>("IPFSNFTHash")
                        .HasColumnType("text")
                        .HasColumnName("ipfs_nft_hash");

                    b.Property<string>("IPFSNFTSize")
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("eArtRegister.API.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("DepositBytecode")
                        .HasColumnType("text")
                    ...
                    b.Property<DateTime?>("DepositCreated")
                        .HasColumnType("timestamp with time zone")
            ...
            modelBuilder.Entity("eArtRegister.API.Domain.Entities.NFTPurchase", b =>
                {
                    b.HasOne("eArtRegister.API.Domain.Entities.NFT", "NFT")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_nft_purchase_nft_nft_id");
