...
namespace eArtRegister.API.Infrastructure.Migrations
{
    ...
    [Migration("20220813132241_TransanctionUpdate")]
    partial class TransanctionUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eArtRegister.API.Domain.Entities.BidPrice", b =>
                {
                    ...
                    b.HasIndex("NFTId")
                        .HasDatabaseName("ix_bid_price_nft_id");

                    b.ToTable("bid_price", "eart");
                });
            ...
            modelBuilder.Entity("eArtRegister.API.Domain.Entities.NFT", b =>
                {
                    ...
                    b.Property<long>("EffectiveGasPrice")
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("OwnerId")
                        .HasDatabaseName("ix_nft_owner_id");
            ...
            modelBuilder.Entity("eArtRegister.API.Domain.Entities.BidPrice", b =>
                {
                    b.HasOne("eArtRegister.API.Domain.Entities.NFT", "NFT")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_bid_price_nf_ts_nft_id");
                    ...
                    b.HasOne("eArtRegister.API.Domain.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_bid_price_users_user_id");
            ...
            modelBuilder.Entity("eArtRegister.API.Domain.Entities.Bundle", b =>
                {
                    b.HasOne("eArtRegister.API.Domain.Entities.User", "Owner")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_bundle_users_owner_id");
            ...
            modelBuilder.Entity("eArtRegister.API.Domain.Entities.BundleRate", b =>
                {
                    ...
                    b.HasOne("eArtRegister.API.Domain.Entities.User", "User")
                        .WithMany("RatedBundles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_bundle_rate_users_user_id");
            ...
            modelBuilder.Entity("eArtRegister.API.Domain.Entities.FollowBundle", b =>
                {
                    ...
                    b.HasOne("eArtRegister.API.Domain.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_follow_bundle_users_user_id");
            ...
            modelBuilder.Entity("eArtRegister.API.Domain.Entities.FollowNFT", b =>
                {
                    ...
                    b.HasOne("eArtRegister.API.Domain.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_follow_nft_users_user_id");
            ...
            modelBuilder.Entity("eArtRegister.API.Domain.Entities.FollowUser", b =>
                {
                    b.HasOne("eArtRegister.API.Domain.Entities.User", "FollowedUser")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_follow_user_users_followed_user_id");
                    ...
                    b.HasOne("eArtRegister.API.Domain.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_follow_user_users_user_id");
            ...
            modelBuilder.Entity("eArtRegister.API.Domain.Entities.NFT", b =>
                {
                    ...
                    b.HasOne("eArtRegister.API.Domain.Entities.User", "Creator")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_nft_users_creator_id");
                    ...
                    b.HasOne("eArtRegister.API.Domain.Entities.User", "Owner")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_nft_users_owner_id");
            ...
            modelBuilder.Entity("eArtRegister.API.Domain.Entities.NFTLike", b =>
                {
                    ...
                    b.HasOne("eArtRegister.API.Domain.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_nft_like_users_user_id");
            ...
            modelBuilder.Entity("eArtRegister.API.Domain.Entities.NFTRate", b =>
                {
                    ...
                    b.HasOne("eArtRegister.API.Domain.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_nft_rate_users_user_id");
            ...
            modelBuilder.Entity("eArtRegister.API.Domain.Entities.PriceOffer", b =>
                {
                    ...
                    b.HasOne("eArtRegister.API.Domain.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_price_offer_users_user_id");
