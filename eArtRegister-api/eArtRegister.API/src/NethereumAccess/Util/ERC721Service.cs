...
namespace NethereumAccess.Util
{
    ...
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ERC721Deployment myERC721Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC721Deployment>().SendRequestAndWaitForReceiptAsync(myERC721Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ERC721Deployment myERC721Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC721Deployment>().SendRequestAsync(myERC721Deployment);
        }

        public static async Task<ERC721Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ERC721Deployment myERC721Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
